...
GetDest:	CALL		GetNextDest
			LOAD		CURRX
			STORE		AtanX
			LOAD		CURRY
			STORE		AtanY		; Preparing for Atan2
			CALL		ArcTan		; AC now has -180 to 180 of angle to dest
			OUT			LCD
			STORE		TargetDiff
Turn:		JNEG		TurnRight
TurnLeft:	LOAD		FSLOW
...
PSL:
	CALL 	Abs
	ADDI 	-1 		; Breakpoint of 5 degrees
	JNEG	Straight
	LOAD 	PS_ANGLE_ERR
	JNEG	PSL_NEG
	JPOS	PSL_POS
...
RSlow:    DW -100
FMid:     DW 200       ; 350 is a medium speed
RMid:     DW -200
